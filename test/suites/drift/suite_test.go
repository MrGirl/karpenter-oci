...
var imageArm = "Oracle-Linux-8.10-aarch64-2025.05.19-0-OKE-1.30.10-764"
var imageArmId = "ocid1.image.oc1.iad.aaaaaaaa7b4fk4q5u7rpwevsk43cworsqjuwwm3yl6lckztdp226dkbafnoa"
...
var _ = Describe("Drift", func() {
	...
	It("should disrupt nodes that have drifted due to subnets", func() {
		...
		subnet1Id := lo.FromPtr(subnet1Resp.Subnet.Id)
		...
		Expect(err).ToNot(HaveOccurred())
		subnet2Id := lo.FromPtr(subnet2Resp.Subnet.Id)
