...
//	ocitest "github.com/zoom/karpenter-oci/pkg/test"
...
//			// the other nodePools
//			driftNodeClass := ocitest.OciNodeClass()
...
//			driftNodeClass.Spec.ImageSelector = []v1alpha1.ImageSelectorTerm{{Name: "test-ami"}}
//
...
//				return r.Key == v1alpha1.LabelInstanceCPU
//			})
//			env.ExpectUpdated(nodePool)
//
